...
<body class="main-layout inner_page">
	...
	<form:form class="form" id="myForm" onsubmit="return validateForm()"
		action="${pageContext.request.contextPath}/PhieuThu/ThemMoi"
		...
		<div class="footer">
			<div class="container">
									...
									<div class="row">
										<div class="col-md-3">
											<div class="form-group">
												<label>Chứng Từ Sổ</label>
												<form:input type="text" path="chungTuSoThu" id="chungtuso"
										...
										<div class="col-4">
											<div class="form-group">
												...
												<form:input type="date" path="ngayLapCT" id="ngaylapct"
													class="form-control" aria-describedby="helpId"
											...
											<div class="col-4" style="margin-top: 25px">
												<div class="form-group d-flex">
													...
													<form:select path="nam" class="form-control" name=""
														style="width:150px" id="yearInput">
													</form:select>
												</div>
											</div>
					...
					<div class="col-3">
						<div class="form-group">
							...
							<form:input type="text" path="maKH" class="form-control" name=""
								id="makhachhang" aria-describedby="helpId" placeholder=""
								oninput="validateMaKH()"></form:input>
					...
					<div class="col-4">
						<div class="form-group">
							...
							<form:input type="text" path="tenKH" class="form-control" name=""
								id="hovatenkh" aria-describedby="helpId" placeholder=""
								oninput="validateTenKH()"></form:input>
					...
					<div class="col-5">
						<div class="form-group">
							...
							<form:input type="text" path="diaChi" class="form-control"
								name="" id="diachi" aria-describedby="helpId" placeholder=""
					...
					<div class="col-8">
						<div class="form-group">
							...
							<form:input type="text" path="noiDungPhieuThu"
								class="form-control" name="" id="noidungphieuthu"
								aria-describedby="helpId" placeholder=""
								oninput="validateNoiDung()"></form:input>
					...
					<div class="col-3 ">
						<div class="form-group ">
							...
							<form:input type="text" path="thanhTienSauThue"
								class="form-control" name="" id="thanhtien"
								aria-describedby="helpId" placeholder=""
					...
					<div class="col-3">
						<div class="form-group ">
							...
							<form:input type="text" path="ghiChu" class="form-control"
								name="" id="ghichu" aria-describedby="helpId" placeholder=""
				...
				<div class="form-check">
					<label class="form-check-label d-flex"> <form:checkbox
							path="daThuTien" id="daThuTien" /> <label
						class="form-check-label" for="defaultCheck1"> Da Thu Tien
					</label>
		...
		<div class="col-12  " style="padding-left: 1127px;">
			<form:button type="submit" class="btn btn-primary" id="submitBtn">Them Moi</form:button>
			...
			<div class="col-4 d-flex">
				...
				<div class="form-group ml-2 ">
					<input type="search" name="" id="nameBT"
						...
						placeholder="Search">
					<!-- 					<button type="button" class="btn " id='seachBT'>
	...
	<p>
		...
		<script>
			/* 		AOS.init();*/
			$(document).ready(function() {
				var daThuTien = document.getElementById("daThuTien");
				var insert = document.getElementById("submitBtn");
				insert.disabled = true;

				$(daThuTien).change(function() {
					if (daThuTien.checked) {
										...
										.keyup(
												function() {
													var selectedRadio = $(
															"#nameBT").val()
															.trim();
													var url = "${pageContext.request.contextPath}/PhieuThu/seach";
													url += "?selectedRadio="
															...
															.ajax({
																	...
																	if (invoices.length == 0) {
																		...
																		for (var i = 0; i < invoices.length; i++) {
																			...
																			var row = "<tr>"
																					...
																					+ "</td>"
																					+ "<td>"
																					+ invoice.noiDungPhieuThu
																					+ "</td>"
																					+ "<td>"
																					+ invoice.thanhTienSauThue
																					+ "</td>"
																					+ "<td>"
																					+ invoice.soTienDaThu
																					+ "</td>"
																					...
																					+ invoice.tuHS
																					+ "</td>"
																					+ "<td><a href='${pageContext.request.contextPath}/PhieuThu/UpdateThu/" + invoice.chungTuSoThu + "'><i class='fa-solid fa-pen'></i></a></td>"
																					+ "</tr>";
																...
																error : function(
																	...
																	/* 			    	 var errorMessage = xhr.responseText;
																				         $("#Erros").text(errorMessage).css("color","red");; */
																}
															});
												})
							})
